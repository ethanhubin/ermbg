...
EVIDENCE_KIND_ALIASES: dict[str, EvidenceKind] = {
    ...
    "glow_soft_alpha_candidate": "translucent_candidate",
...
def default_tool_catalog() -> dict[str, ToolSpec]:
    ...
    return {
        ...
        "preserve_soft_alpha": ToolSpec(
            ...
            allowed_region_kinds=("soft_edge_band", "translucent_candidate", "glow_soft_alpha_candidate"),
        ...
        "mark_translucent": ToolSpec(
            ...
            allowed_region_kinds=("translucent_candidate", "glow_soft_alpha_candidate", "unknown"),
