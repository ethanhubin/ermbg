...
- Keep `comfy-ermbg` as the full ERMBG fallback, diagnostic path, and comparison
  candidate.
...
uploaded image
  ...
  -> recommended CorridorKey settings
...
CorridorKey: input analysis, parameter adaptation, mask hints, diagnostics,
batch evaluation, and Web controls.
